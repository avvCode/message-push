...
(
    ...
    `send_channel`     int(10) NOT NULL DEFAULT '0' COMMENT '消息发送渠道：10.IM 20.Push 30.短信 40.Email ',
...
(
    ...
    `creator` varchar(128) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'vv' COMMENT '拥有者',
    `created`        int(11) NOT NULL DEFAULT '0' COMMENT '创建时间',
    `updated`        int(11) NOT NULL DEFAULT '0' COMMENT '更新时间',
    `is_deleted`     tinyint(4) NOT NULL DEFAULT '0' COMMENT '是否删除：0.不删除 1.删除',
    PRIMARY KEY (`id`),
